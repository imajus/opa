...
async function getPermit(
  ...
  // console.log('Allowance before permit', await token.allowance(owner, spender));
  // await token.connect(wallet).permit(owner, spender, value, deadline, v, r, s);
  // console.log('Allowance after permit', await token.allowance(owner, spender));
