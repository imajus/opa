...
/**
 * Maker token amount validation - cloned from uint256
 */
export const makerTokenAmount = uint256.describe(
  'Maker token amount validation'
);

/**
 * Taker token amount validation - cloned from uint256
 */
export const takerTokenAmount = uint256.describe(
  'Taker token amount validation'
);
